...
I then omitted dgh values, as younger trees may have a different response/behaviour to drought events. I then omitted dgh values, as younger trees may have a different response/behavior to drought events.
...
```{r}
NWT_growthSPEI$main <- ifelse(is.na(NWT_growthSPEI$main) | NWT_growthSPEI$main == "", 
                              NWT_growthSPEI$enq, 
                              NWT_growthSPEI$main)
...
BCI_growthSPEI$main <- ifelse(is.na(BCI_growthSPEI$main) | BCI_growthSPEI$main == "", 
                              BCI_growthSPEI$enq, 
                              BCI_growthSPEI$main)
...
```{r}
write.xlsx(NWT_data, "NWT_growthSPEI_cleaned.xlsx")


write.xlsx(BCI_data, "BCI_growthSPEI_cleaned.xlsx")
```
